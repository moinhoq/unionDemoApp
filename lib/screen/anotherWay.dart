        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 10),
              CommonWidget.buildTextFormField(controller: phoneController, labelText: "Email",prefixIcon: Icons.email_outlined),
              Padding(
                  ...
                  onPressed: () {
                    showDialog(
                      ...
                      builder: (ctx) => AlertDialog(
                        ...
                        content: const Text(
                            "An Email have been send to your given email id"),
                        actions: <Widget>[
                          TextButton(
                            onPressed: () {
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => Forgerpassword()));
                  },
                ),
              ),
